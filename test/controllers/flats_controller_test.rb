...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { category: @flat.category, description: @flat.description, name: @flat.name, owner: @flat.owner, price: @flat.price, user_id: @flat.user_id } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { category: @flat.category, description: @flat.description, name: @flat.name, owner: @flat.owner, price: @flat.price, user_id: @flat.user_id } }
